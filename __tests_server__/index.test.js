...
describe('Test new assigned training', () => {
  test('sample', (done) => {
    request(app)
      ...
      .then((response) => {
        expect(response.text).toBe("{\"date_created\":\"2022-04-16\",\"at_id\":\"54\",\"e_id\":\"5\",\"title\":\"hi\",\"description\":\"hi\",\"link\":\"hi\",\"date_due\":\"2022-05-16\",\"progress\":\"Not-started\",\"assigned_to\":\"6\"}")
        done()
      })
  }) 
})
...
describe('Test new performance review', () => {
  test('sample', (done) => {
    request(app)
      ...
      .then((response) => {
        expect(response.text).toBe( "{\"date_created\":\"2022-04-09\",\"pr_id\":\"33\",\"e_id\":\"1\",\"title\":\"hi\",\"overall_comments\":null,\"growth_feedback\":null,\"kindness_feedback\":null,\"delivery_feedback\":null,\"progress\":\"Not-started\",\"assigned_to\":\"2\"}")
        done()
      })
  }) 
})
